  ...
  return (
    <>
      ...
      <div className="  h-full md:h-auto bg-mainBg overflow-hidden">
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-center items-center  relative w-full sm:ml-0 sm:pr-2  ">
              ...
              <div className=" flex items-center justify-start lg:justify-end pl-5 lg:p-1   w-full md:w-[75%]   ">
                ...
                <div className="relative ml-3">
                  <a className="w-8 h-8 mr-2  bg-newBlue font-bold flex justify-center items-center rounded-full  ">
        ...
        <header className="block w-full   pt-1 items-center relative z-10  ">
          <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-between items-center  relative w-full px-2 lg:pl-6 lg:pr-8">
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-end items-center w-full  ">
              ...
              <div className="mt-3 lg:mt-0  lg:ml-2 items-between  px-3 py-2 bg-white border-[1px] border-lightGray h-10 rounded-sm shadow-sm flex justify-center items-center">
        ...
        <div
          className={`h-10 w-10 mr-2 ${
            e.isToday
              ...
              : "shadow-inner bg-[#EFECFB] text-black drop-shadow-xl"
          }  flex items-center justify-center rounded-full`}
        >
          {moment(e.date).format("DD")}
        </div>
        <div className="mt-2 text-lg uppercase font-normal">
