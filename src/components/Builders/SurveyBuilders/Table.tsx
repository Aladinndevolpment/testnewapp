...
export default function Table({ data }: any) {
  ...
  <BsThreeDotsVertical/>
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleClose} className="flex gap-2">View Survey Live <GoLinkExternal className="text-gray-500  h-4 w-4"/></MenuItem>
        ...
        <MenuItem onClick={handleClose}>Save Survey as Template</MenuItem>
        <MenuItem onClick={handleClose}>Archieve </MenuItem>
        <MenuItem onClick={handleClose} style={{color:"red"}}>Delete Survey </MenuItem>
      </StyledMenu>
              </div>
            )}
