      ...
      >
        ...
        <div
          className={`w-full h-auto ${size} mr-2 ${
            hovered &&
            "hover:outline-pink-500 hover:outline-dashed hover:outline "
        ...
        >
          {hovered && (
            <>
              <div className="absolute top-0 right-0 bg-yellow-500 text-white text-[10px] px-1 z-10 capitalize">
                {elementName}
              </div>
              <div
                className="absolute bottom-0 left-[50%] bg-yellow-500 text-white text-[10px] px-1 z-10 capitalize"
                onClick={() => {
