        ...
        <div className="mt-3">
          <div className="flex flex-col gap-1">
            ...
            <Select
              ...
              className=" rounded-md  text-sm font-medium bg-transparent focus:bg-transparent w-full placeholder-dark border-gray-200 text-space focus:outline-none focus:border-gray-200 text-black"
            >
