              ...
              {radioData?.map((mainData: any, mainIndex: any) => (
                <li className="mb-1" key={mainIndex}>
                  ...
                  <Select
                    ...
                    className="px-2 rounded-lg mt-2 mb-2  text-sm font-medium bg-transparent focus:bg-transparent w-1/2  placeholder-dark   text-space focus:outline-none focus:border-gray-300 text-black"
                  >
