...
const setupDevice = async (
  ...
  const setupTwilioDevice = async () => {
    axios
      .get("https://stagingmachine.tech/api/token")
          ...
          >
            ...
            >
              {chipList.map((chip, index) => (
                <div className="rounded-full flex items-center justify-center p-1 bg-blue-50 text-blue-500" key={index}>
                  <span className="text-xs mr-1">{chip}</span>
                  <button className="w-4 h-4 rounded-full border items-center justify-center flex" key={index}>
                    <RxCross2
...
export default function Dialpad() {
  ...
  useEffect(() => {
    setupDevice(ctx, startIncomingCall, setCallDetails, setCurrentCall, endCall);
  }, [ctx.showDialer]);
            ...
            <div className="text-black pb-4 space-y-2 -mt-4">
              <div className="flex justify-center space-x-5">
                <button
                  ...
                  onClick={() => { setPhoneNumber(phoneNumber + "1"); inputRef.current?.focus() }}
                >
                ...
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "2"); inputRef.current?.focus() }}
                >
                ...
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "3"); inputRef.current?.focus() }}
                >
              ...
              <div className="flex justify-center space-x-5">
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "4"); inputRef.current?.focus() }}
                >
                ...
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "5"); inputRef.current?.focus() }}
                >
                ...
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "6"); inputRef.current?.focus() }}
                >
              ...
              <div className="flex justify-center space-x-5">
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "7"); inputRef.current?.focus() }}
                >
                ...
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "8"); inputRef.current?.focus() }}
                >
                ...
                <button
                  className="flex flex-col items-center rounded-full w-14 h-14 border"
                  onClick={() => { setPhoneNumber(phoneNumber + "9"); inputRef.current?.focus() }}
                >
              ...
              <div className="flex justify-center space-x-5">
                <button
                  ...
                  onClick={() => { setPhoneNumber(phoneNumber + "*"); inputRef.current?.focus() }}
                >
                ...
                <button
                  ...
                  {...zeroLongPressEvent}
                >
                  <span className="text-2xl mt-1 font-main font-semibold">0</span>
