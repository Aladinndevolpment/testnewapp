              ...
              <div>
                ...
                <div>
                  <Select
                    ...
                    className={`${styles.selectTag} px-2 rounded-lg mt-2 text-sm font-medium bg-transparent focus:bg-transparent w-full placeholder-dark   text-space focus:outline-none focus:border-gray-300 text-black  bg-[#e9f1f8]`}
                  >
                ...
                <div>
                  <Select
                    ...
                    className="px-2 rounded-lg  mb-2  text-sm font-medium bg-transparent focus:bg-transparent w-full placeholder-dark   text-space focus:outline-none focus:border-gray-300 text-black bg-[#e9f1f8]"
                  >
