...
export default function Simpledata( { index } ) {
  ...
  return (
        ...
        <div className="bg-white rounded-md shadow w-100 py-3 px-2 relative" style={{width: '100%', height: '100%', overflow: 'scroll'}}>
                <div className="flex items-center justify-between mb-3">
                    <p className="font-medium text-sm">Amount by stage</p>
                </div>
                <div className='grid grid-flow-row gap-2 max-h-96'>
                <div className="border border-gray-300 rounded p-[0.8rem]" /*style={{padding: '0.45rem'}}*/>
