    ...
    <div>
      <div className=" h-[75vh] overflow-y-scroll scrollbar-hide">
        <form onSubmit={handleSubmit} className="flex flex-wrap px-2  ">
          ...
          <h1 className="w-full mb-2 mt-5 text-base text-dark font-semibold uppercase">
            Drop-Your-File
          </h1>
          {attachment == false ? (
            <button
              ...
              className="flex items-center justify-center bg-[#ed754b] text-white px-6 py-1 w-2/4 rounded font-bold mt-2 hover:bg-[#ed825c]"
            >
              {" "}
              <MdUpload />
              Upload File
